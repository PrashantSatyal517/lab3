/*evalutation of a postfixed expression
* Author:prashant Satyal
* Reference:Data stucture and algirithm book (pearson) page 98 to 101
*/
...
{
	char exp[100];
	printf ("Enter a postfixed expression to be evaluated \n");
	gets(exp);
	printf ("%s \n", exp);
